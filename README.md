...
| :----------------------------------------------------------: | :----------------------------------------------------------: |
| 2. When the computer is found, a remote control session can begin. | 3. Phone/Keyboard button illustrates the software keyboard, tap it to open it up. |
...
| :----------------------------------------------------------: | :----------------------------------------------------------: |
| 4. The PC/Keyboard button illustrates a hardware keyboard, tap it to open media- and other useful hardware keys. | 5. Message Mode: Input behaves chat-app like. Tap the paper plane icon to send the message (return/enter does NOT send). |
